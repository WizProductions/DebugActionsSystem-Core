...
#include "DebugActionsSystemCoreEditorMode.generated.h"
 ...
 */
UCLASS()
class UDebugActionsSystemEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DebugActionsSystemEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UDebugActionsSystemEditorMode();
	virtual ~UDebugActionsSystemEditorMode();
