...
#define LOCTEXT_NAMESPACE "DebugActionsSystemSimpleTool"
...
UDebugActionsSystemSimpleToolProperties::UDebugActionsSystemSimpleToolProperties()
{
...
void UDebugActionsSystemSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UDebugActionsSystemSimpleToolProperties>(this);
