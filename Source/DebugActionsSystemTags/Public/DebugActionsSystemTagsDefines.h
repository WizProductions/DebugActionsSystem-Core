...
DAS_DECLARE_SHARED_DI_GAMEPLAY_TAG_EXTERN(StringETB_Default);
DAS_DECLARE_SHARED_DI_GAMEPLAY_TAG_EXTERN(LocalPlayerSelector_Default);
DAS_DECLARE_SHARED_DI_GAMEPLAY_TAG_EXTERN(ObjectSelector_Default);

//==== DAS - Tags - Custom ====\\.
DAS_DECLARE_SHARED_DI_GAMEPLAY_TAG_EXTERN(LevelSelector);
DAS_DECLARE_SHARED_DI_GAMEPLAY_TAG_EXTERN(LevelOptions);
